...
<p>
    In order to strengthen the Unify branding we built a landing page for the
    app. The website also provided us with a suitable (and necessary) place to
    put things such as privacy policies, contact details and GDPR compliance
